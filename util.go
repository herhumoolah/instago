...
// Whether we want to launch the stories mode
var stories *bool

// Whether we want to launch the basic data mode
var bdata *bool

// Whether we want to launch the basic data mode
var post *bool

// Whether we want to launch the basic data, post and stories mode
var all *bool
...
func parseOptions() {
	post = flag.Bool("post", false, "Use this option to get post")
	stories = flag.Bool("stories", false, "Use this option to get stories")
	bdata = flag.Bool("bdata", false, "Use this option to get basic data")
	all = flag.Bool("all", false, "Use this option to get post, stories and basic data")
